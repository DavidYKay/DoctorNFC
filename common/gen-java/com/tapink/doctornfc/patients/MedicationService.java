              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Medication>(_list16.size);
                  for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                  {
                    Medication _elem18; // required
                    _elem18 = new Medication();
                    _elem18.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, get_medications_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Medication _iter19 : struct.success)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Medication _iter20 : struct.success)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Medication>(_list21.size);
            for (int _i22 = 0; _i22 < _list21.size; ++_i22)
            {
              Medication _elem23; // required
              _elem23 = new Medication();
              _elem23.read(iprot);
